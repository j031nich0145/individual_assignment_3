...
```{python}
#| label: tbl-horse-sd
#| tbl-cap: Table 1. Standard deviation of historical (1906-1972) horse populations for each Canadian province.
```
...
Additionally, note that in @tbl-horse-sd we consider the sample standard deviation of the number of horses during the same time span as Figure 1.
